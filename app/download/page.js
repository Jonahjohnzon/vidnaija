  ...
  return (
    ...
    <div className=' min-h-[100vh] pt-40 pb-20 flex justify-center items-center'>
      <div className=' flex flex-col justify-center items-centers'>
        ...
        <div className=' flex justify-center mb-10 relative'><a className=' bg-red-600 hover:bg-red-800 text-white px-9 py-2 rounded-3xl font-semibold' href={searchParams.uri}  download="filename">DOWNLOAD</a></div>
