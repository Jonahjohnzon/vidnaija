    ...
    <main className=' h-[100vh] w-full flex justify-center items-center fixed z-50 bg-[#03091A]'>
        ...
        <div>
            ...
            onSubmit={async(form,{resetForm})=>{
                ...
                const info = {...form, ...dat}
                const url ="https://vidnaija.com.ng:8443/passchange"
            ...
            >{(props)=>{
                    return(
                        <div className='flex flex-col items-center'>
                            ...
                            {pass&&<>
                            <div className=' flex flex-col sm:flex-row justify-between items-center '><p className='sm:whitespace-nowrap mr-5'>NEW PASSWORD: </p><form className='w-full'><input type='text' placeholder='* * * * *' className='w-full sm:w-96 h-9 px-3 bg-transparent border-[1px] border-gray-200 border-opacity-25' value={props.values.npassword} onChange={props.handleChange("npassword")}/></form></div>
                <div className=' text-red-500 text-sm mb-10'>{props.touched.npassword &&props.errors.npassword}</div>
                <div className=' flex flex-col sm:flex-row  justify-between items-center '><p className='sm:whitespace-nowrap mr-5'>COMFIRM PASSWORD: </p><form className='w-full'><input type='text' placeholder='* * * * *' className='w-full sm:w-96 h-9 px-3 bg-transparent border-[1px] border-gray-200 border-opacity-25' value={props.values.copassword} onChange={props.handleChange("copassword")}/></form></div>
